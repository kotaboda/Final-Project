...
public class Floor2 extends Floor {
	...
	public Floor2(Player player) {
		...
		//TODO Need to come up with actual notes. This was throwing errors because they didn't exist.
		notesTemp[6] = new Note("Blah Blah Blah");
		notesTemp[7] = new Note("MOre Blah");
